...
.post(cors.cors,(req,res,next)=>{
  ...
  */
  var transporter = nodemailer.createTransport({
    service: 'gmail',
    auth: {
      user: 'yakoubiomran007@gmail.com',//replace with your email
      pass: 'dofxkkvenbqopwov'//replace with your password
    }
  }); 
  ...
  */
  var mailOptions = {
    ...
    subject: `Réunion`,
    html:`Bonjour,<br>
    Félicitation, votre compte  a été créé. Voici les paramètres :<br>
    
    email:`+req.body.email+`<br>
    Mot de passe :`+req.body.mdp
  };
...
module.exports = emailRouter;var express=require('express');
var bodyParser = require('body-parser')// importing body parser middleware to parse form content from HTML
var cors = require('./../cors');
//const emailRouter = express.Router();
var nodemailer = require('nodemailer');//importing node mailer
...
.post(cors.cors,(req,res,next)=>{
  ...
  */
  var mailOptions = {
    ...
    html:`Vous êtes invité(e) à une réunion à la date indiquée.<br>`+req.body.mdp
  };
